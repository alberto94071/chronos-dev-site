  ...
  return (
    <section id="about" ref={ref} className="sec-pad" style={{ borderBottom: "1px solid var(--color-border)" }}>
      ...
      <div className="aos" style={{ textAlign: "center", marginBottom: 48 }}>
        ...
        <div style={{ fontSize: 28, color: "var(--color-primary)", marginBottom: 16 }}>✦</div>
        ...
        {active === "Servicios" && (
          <div className="grid-services">
            {[
              ...
              return (
                <div key={s.n} style={{ background: "var(--color-surface)", border: "1px solid var(--color-border)", padding: "20px 18px" }}>
        ...
        {active === "Stack" && (
          <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
            {["Next.js 15","React 19","TypeScript","Python","Claude API","Neon PostgreSQL","Cloudinary","NextAuth.js v5","Vercel","Tailwind CSS","Resend","Stripe","Zustand","Node.js"].map(function (tech) {
              return (
                <span key={tech} style={{ background: "var(--color-primary-ghost, #7aff0015)", color: "var(--color-primary)", border: "1px solid var(--color-glow, #7aff0033)", fontSize: 11, padding: "6px 14px", fontFamily: "JetBrains Mono, monospace" }}>
                  {tech}
                </span>
              );
            })}
              ...
              return (
                <div key={s.skill}>
                  ...
                  <div style={{ height: 4, background: "var(--color-border)", borderRadius: 2 }}>
                    <div style={{ height: "100%", width: s.level + "%", background: "var(--color-primary)", borderRadius: 2 }} />
                  </div>
                </div>
              );
            })}
      ...
      <div className="aos" style={{ marginTop: 64 }}>
        ...
        {[
          ...
          return (
            <div key={a.name} className={"grid-awards aos d" + (i + 1)}>
